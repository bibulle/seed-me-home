...
import { DirectDownloadItemComponent } from './direct-download-item/direct-download-item.component';
import { MatDialogModule } from '@angular/material/dialog';
import { MatMenuModule } from '@angular/material/menu';
import { MatProgressBarModule } from '@angular/material/progress-bar';

@NgModule({
  declarations: [DirectDownloadComponent, DirectDownloadItemComponent],
