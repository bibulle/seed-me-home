...
describe('RtorrentService', () => {
  ...
  void beforeAll(async () => {
    ...
    mockRtorrent = {
      ...
      getTorrentFiles: (hash, callback) => {
        if (hash === '4A03DA39750C4BDD0FEBB66D8B138CEEA5993FAA') {
          callback(null, [
            {
              range_first: '0',
              range_second: '2208',
  ...
  void it('getAll return should be ok', done => {
    service.forceRtorrentForMocking(mockRtorrent);
  ...
  void it('getTorrentFiles return should be ko on wrong hash', done => {
    service.forceRtorrentForMocking(mockRtorrent);
    service.getTorrentFiles('5A03DA39750C4BDD0FEBB66D8B138CEEA5993FAA', err => {
  ...
  void it('getTorrentFiles return should be ok', done => {
    service.forceRtorrentForMocking(mockRtorrent);
    service.getTorrentFiles('4A03DA39750C4BDD0FEBB66D8B138CEEA5993FAA', (err, data) => {
      expect(err).toBeNull();
      expect(data).toEqual([
        {
          range_first: '0',
